                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <div class="action-buttons">
                            <a href="{{ route('admin.store.edit', $store->id) }}" class="btn btn-outline-primary btn-sm me-2">
                                ...
                                <tr class="row1" data-id="{{ $coupon->id }}">
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm" role="group">
                                            <a href="{{ route('admin.coupon.edit', $coupon->id) }}" class="btn btn-outline-primary" data-bs-toggle="tooltip" title="Edit">
